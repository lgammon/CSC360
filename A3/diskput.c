...
// Function to find a file in the filesystem image
...
// Function to copy file contents to a new file
...
int main(int argc, char* argv[]) {
    ...
    int skip = 64; // Adjust this based on your logic for file skipping
